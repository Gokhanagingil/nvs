...
4. No Incident, SLA, identity, fixture, or cleanup mutation is implemented in M1-01.
5. All unstable NILES transport details remain isolated in `packages/adapter-niles`.
6. Unknown and missing capabilities above become M1-02 prerequisites or explicit blockers; they are never interpreted as passing behavior.

## M1-02 backlog

- Reconcile policy and service behavior for reopen target state and closure authority before freezing assertions.
